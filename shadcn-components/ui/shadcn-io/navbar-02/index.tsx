...
const defaultNavigationLinks: Navbar02NavItem[] = [
  ...
  },
  {
    ...
    type: "simple",
    items: [
      { href: "/players/division1", label: "Division 1" },
      { href: "/players/division2", label: "Division 2" },
      { href: "/players/division3", label: "Division 3" },
      { href: "/players/alldivisions", label: "All divisions" },
    ],
  },
  {
    label: "Match results",
    ...
    type: "simple",
    items: [
      { href: "/results/division1", label: "Division 1" },
      { href: "/results/division2", label: "Division 2" },
      { href: "/results/division3", label: "Division 3" },
      { href: "/results/alldivisions", label: "All divisions" },
    ],
  },
  {
    label: "Match results",
